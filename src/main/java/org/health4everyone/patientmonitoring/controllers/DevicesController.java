...
public class DevicesController {
	...
	@RequestMapping(value = "/devices/data", method = { RequestMethod.GET, RequestMethod.POST })
	public DashboardData devicesData(Model mode, Principal principal,@RequestParam(value = "days", defaultValue = "15", required=true)int dataDays) {
