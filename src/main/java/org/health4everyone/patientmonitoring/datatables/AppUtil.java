package org.health4everyone.patientmonitoring.datatables;
...
public class AppUtil {
	...
	public static String buildPaginatedQuery(String baseQuery, PaginationCriteria paginationCriteria) {
		...
		StringBuilder sb = new StringBuilder("SELECT FILTERED_ORDERD_RESULTS.* FROM (SELECT BASEINFO.* FROM ( #BASE_QUERY# ) BASEINFO #WHERE_CLAUSE#  #ORDER_CLASUE# ) FILTERED_ORDERD_RESULTS OFFSET (#PAGE_NUMBER# * #PAGE_SIZE#) LIMIT #PAGE_SIZE#");
