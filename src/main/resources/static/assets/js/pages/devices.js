$(document).ready(function(){
	...
	$("#devices-datatable").DataTable({
		language:{
			...
			info:"Showing devices _START_ to _END_ of _TOTAL_",
			lengthMenu:'Display <select class=\'custom-select custom-select-sm ml-1 mr-1\'><option value="5">5</option><option value="10">10</option><option value="20">20</option><option value="-1">All</option></select> devices'
		},
		pageLength:5,
		columns:[{
			orderable:!1,
