!function(i){
	...
	e.prototype.initCharts=function(){
		...
		var r={
			...
			series:[{name:"Values received",data:[11,33,22,44,11,33,22,11,0,33,44,33,44,44,44]}],
			zoom:{enabled:!1},
			legend:{show:!1},
			colors:a,
		...
		new ApexCharts(document.querySelector("#values-received-overview"),r).render();
		for(var s=[],n=10;1<=n;n--)
			s.push(n+" min ago");
		...
		r={
			...
			plotOptions:{
				bar:{
					horizontal:!1,endingShape:"rounded",columnWidth:"22%",dataLabels:{position:"top"}
				}
			},
			dataLabels:{
				enabled:!0,
		...
		zoom:{enabled:!1},legend:{show:!1},colors:a,xaxis:{categories:s,labels:{show:!1},axisTicks:{show:!1},axisBorder:{show:!1}},yaxis:{labels:{show:!1}},
		fill:{type:"gradient",gradient:{inverseColors:!0,shade:"light",type:"horizontal",shadeIntensity:.25,gradientToColors:void 0,opacityFrom:1,opacityTo:1,stops:[0,100,100,100]}},
	...
	r={
		...
		colors:a,
		dataLabels:{enabled:!1},
		series:[{name:"Sessions",data:[44,11,2]}],
		xaxis:{categories:["Romania","Japan","United States"],axisBorder:{show:!1},labels:{formatter:function(e){return e+"%"}}},
	...
	r={
		...
		plotOptions:{radialBar:{dataLabels:{name:{fontSize:"22px"},value:{fontSize:"16px"},total:{show:!0,label:"OS",formatter:function(e){return 8541}}}}},
		colors:a,
		series:[44,55,67,83],
...
e.prototype.initMaps=function(){
	0<i("#world-map-markers").length&&i("#world-map-markers").vectorMap({
		...
		series:{regions:[{values:{RO:"#e6ebff",CA:"#b3c3ff",GB:"#809bfe",NL:"#4d73fe",IT:"#1b4cfe",FR:"#727cf5",JP:"#e7fef7",US:"#e7e9fd",CN:"#8890f7",IN:"#727cf5"},attribute:"fill"}]},
		backgroundColor:"transparent",zoomOnScroll:!1})},e.prototype.init=function(){i("#dash-daterange").daterangepicker({singleDatePicker:!0}),this.initCharts(),this.initMaps(),window.setInterval(function(){var e=Math.floor(600*Math.random()+150);i("#active-users-count").text(e),i("#active-views-count").text(Math.floor(Math.random()*e+200))},2e3)},i.AnalyticsDashboard=new e,i.AnalyticsDashboard.Constructor=e}(window.jQuery),function(){"use strict";window.jQuery.AnalyticsDashboard.init()}();